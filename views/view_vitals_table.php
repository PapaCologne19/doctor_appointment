                        ...
                        <div class="card">
                            <div class="container">
                                ...
                                <div class="container px-5">
                                    <form action="vital_table_display.php" class="form-group" method="POST">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            $user = $users->select_profile3();

                                            while($row = $user->fetch(PDO::FETCH_ASSOC)){

                                             ?>
                                       
                                             <option value="<?php echo $row['emp_id']?>"><?php echo $row['profile_name']?></option>
                                            <?php } ?>
                                                </select>
                                            </div>
                                        </div>
