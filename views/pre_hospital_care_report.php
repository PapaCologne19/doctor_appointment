                            ...
                            <div class="container">
                                ...
                                <div class="container px-5">
                                    <form action="action.php" class="form-group" method="POST">
                                        <h2 class="fs-6">INCIDENT'S INFORMATION</h2>
                                        <div class="row mt-1">
                                            <div class="col-md-2">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6">
                                                <select name="patient_status" id="patient_status" class="form-select" required>
                                                    <option value="">Select</option>
...
<!-- 
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6">
                                                <select name="patient_vaccinated" id="patient_vaccinated" class="form-select" required>
                                                    <option value="">Select</option>
                                                    <option value="YES">YES</option>
                                                    <option value="NO">NO</option>
